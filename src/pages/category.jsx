...
const wishlistIndex = wishlistItm.map((curElem)=>{
  ...
  const filterCate = ApiData.filter((curELem) => {
    return curELem.category === categoryname;
  });
//   setFilteData(filterCate);
  console.log("filte Data", filterCate)
                ...
                <div className="card h-100 shadow-sm">
                  ...
                  <div className="card-body">
                    ...
                    <div className="d-grid gap-2 my-4">
                      <button className="btn btn-warning bold-btn" onClick={()=>addtocart(curElem)}>
                    add to cart
                  </button>
                    </div>
